...
"""path Paramters and Number Validations 路径参数和数字校验"""


# 路由是有顺序的
@app03.get("/path/parameters")
def path_params():
    return {"message": "this a message"}
...
def latest(city: CityName):
    if city == CityName.Beijing:
        return {"city_name": city, "message": "hello Beijing"}
    if city == CityName.Shanghai:
        return {"city_name": city, "message": "hello shagng"}
