...
app.include_router(app03, prefix='/demo3', tags=['第三 请求参数和验证'])
app.include_router(app04, prefix='/demo4', tags=['第四 响应处理和FastAPI配置'])
app.include_router(app05, prefix='/demo5', tags=['第五 FastAPI的依赖注入系统'])
app.include_router(app06, prefix='/demo6', tags=['第六 安全、认证和授权'])
app.include_router(app07, prefix='/demo7', tags=['第七 FastAPI的数据库操作和多应用的目录结构设计'])
app.include_router(app08, prefix='/demo8', tags=['第八 中间件、CORS、后台任务、测试用例'])
